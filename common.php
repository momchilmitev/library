...
$genreRepository = new \App\Repositories\GenreRepository($db, $dataBinder);
$bookRepository = new \App\Repositories\BookRepository($db, $dataBinder);
$genreService = new \App\Services\GenreService($genreRepository);
$bookService = new \App\Services\BookService($bookRepository, $userService);
